    ...
    return (
      ...
      <section> 
        <div style={{display:'inline-block', textAlign:'center'}}> 
          ...
          <img src="./Images/Hobbies.jpg" alt="Picture Of Instruments" className="about-image"  style={{width:'18.85%'}} />
          <img src="./Images/School.png" alt="University Logo" className="about-image" style={{width:'30%'}} /> 
        </div>
        <p>
