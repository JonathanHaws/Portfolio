    ...
    return (
      ...
      <section> 
        <div style={{display:'inline-block', textAlign:'center'}}> 
          <img src="https://avatars.githubusercontent.com/u/108207472?s=400&u=33be1111d8e0452cb41f68f643a367ba64e27d71&v=4" class="about-image" style={{width:'30%'}} />
          <img src="./Portfolio/Images/Hobbies.jpg" alt="Picture Of Instruments" class="about-image"  style={{width:'18.85%'}} />
          <img src="./Portfolio/Images/School.png" alt="University Logo" class="about-image" style={{width:'30%'}} /> 
        </div>
        <p>
